      ...
      //initialize all the objects for the features - Must match the number of buttons present / True False rep initial active state
      var optionsArr = [];
      ...
      function updatePrice(price_div_class) {
        ...
        for(var i = 0; i < allKeys.length; i++){
          ...
          //alert("This is the getItem return in updatePrice " + f_string);
          //var f_string = sessionStorage.getItem(sessionStorage.key(i));
      ...
      //Assign the feature-objects to the corresponding elements
      ...
      //Update in price and active status styling function
      function updateInfo(el) {
          ...
          //Filter from all the buttons to get a list of the only element's group
          ...
          for(var i = 0; i < group_filtered.length; i++){
          		//group_filtered[i].className = "inactive";
          ...
          //alert("This is the updateInfo element that will be set in sessionStorage: " + elementGroupString + " " + elementJSONString);
